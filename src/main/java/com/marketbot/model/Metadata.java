...
public class Metadata {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("intentId", intentId).append("webhookUsed", webhookUsed).append("webhookForSlotFillingUsed", webhookForSlotFillingUsed).append("intentName", intentName).append("additionalProperties", additionalProperties).toString();
    }
